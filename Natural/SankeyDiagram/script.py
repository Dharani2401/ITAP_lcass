...
try:
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\Natural\SankeyDiagram\page1.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\Natural\SankeyDiagram\page2.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\Natural\SankeyDiagram\page3.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\Natural\SankeyDiagram\page4.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\Natural\SankeyDiagram\page5.png')
    msg_count=0
    pass_count=0
    fail_count=0
    if len(a)>=1:
    ...
    with open(r"D:\iTAP\Recorded_Scenarios\Natural\SankeyDiagram\logfile.log", "w+") as external_file:
    ...
    path = open(r"D:\iTAP\Recorded_Scenarios\Natural\SankeyDiagram\logfile.log", "w+")
