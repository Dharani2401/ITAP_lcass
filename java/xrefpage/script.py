...
try:
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\xrefpage\page1.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\xrefpage\page2.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\xrefpage\page3.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\xrefpage\page4.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\xrefpage\page5.png')
    msg_count=0
    pass_count=0
    fail_count=0
    if len(a)>=1:
    ...
    with open(r"D:\iTAP\Recorded_Scenarios\java\xrefpage\logfile.log", "w+") as external_file:
    ...
    path = open(r"D:\iTAP\Recorded_Scenarios\java\xrefpage\logfile.log", "w+")
