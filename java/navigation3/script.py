...
try:
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\navigation3\page1.png')
    ...
    with open(r"D:\iTAP\Recorded_Scenarios\java\navigation3\logfile.log", "w+") as external_file:
    ...
    path = open(r"D:\iTAP\Recorded_Scenarios\java\navigation3\logfile.log", "w+")
