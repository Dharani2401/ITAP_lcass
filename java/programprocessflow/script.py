...
try:
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\programprocessflow\page1.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\programprocessflow\page2.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\programprocessflow\page3.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\programprocessflow\page4.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\programprocessflow\page5.png')
    msg_count=0
    pass_count=0
    fail_count=0
    if len(a)>=1:
    ...
    with open(r"D:\iTAP\Recorded_Scenarios\java\programprocessflow\logfile.log", "w+") as external_file:
    ...
    path = open(r"D:\iTAP\Recorded_Scenarios\java\programprocessflow\logfile.log", "w+")
