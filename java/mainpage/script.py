...
try:
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\mainpage\page1.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\mainpage\page2.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\mainpage\page3.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\mainpage\page4.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\java\mainpage\page5.png')
    msg_count=0
    pass_count=0
    fail_count=0
    if len(a)>=1:
    ...
    with open(r"D:\iTAP\Recorded_Scenarios\java\mainpage\logfile.log", "w+") as external_file:
    ...
    path = open(r"D:\iTAP\Recorded_Scenarios\java\mainpage\logfile.log", "w+")
