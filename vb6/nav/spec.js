              ...
              describe('vb6', function() {
                    it('nav', function() { 
						console.log('Application_name : vb6, Scenario_name : nav');
...
browser.sleep(3000);element.all(by.xpath(`//li`)).get(16).isPresent().then(function (text) {
...
if(`getText()`=="getText()"){
assert=Get_Text.get(`//li[17]`)  }
if(`getText()`=="getAttribute('value')"){
assert=Get_Attribute.get(`//li[17]`)  }
