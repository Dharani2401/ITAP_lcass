              ...
              describe('vb6', function() {
                    it('spiderpage', function() { 
						console.log('Application_name : vb6, Scenario_name : spiderpage');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\spiderpage";
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-spiderfilterapp/div[3]/div/div[6]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-spiderfilterapp/div[3]/div/div[6]/button is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-spiderfilterapp/div[3]/div/div[6]/button is not present in current page. :Assertion Failed`);
browser.quit();
}
});
