...
try:
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\vb6\nav2\page1.png')
    ...
    with open(r"D:\iTAP\Recorded_Scenarios\vb6\nav2\logfile.log", "w+") as external_file:
    ...
    path = open(r"D:\iTAP\Recorded_Scenarios\vb6\nav2\logfile.log", "w+")
