              ...
              describe('vb6', function() {
                    it('ruleharvestingcount', function() { 
						console.log('Application_name : vb6, Scenario_name : ruleharvestingcount');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\ruleharvestingcount";
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[5]/div[4]/select/option[3]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre/div[5]/div[4]/select/option[3] is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre/div[5]/div[4]/select/option[3] is not present in current page. :Assertion Failed`);
browser.quit();
}
});
element(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[6]/div[2]/select/option[2]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre/div[6]/div[2]/select/option[2] is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre/div[6]/div[2]/select/option[2] is not present in current page. :Assertion Failed`);
browser.quit();
}
});
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[8]/div/div/div/div[4] is equal toShowing 1 to 2 of 2 entries. :Assertion Passed` );
}else{
...
browser.wait(until.presenceOf(element(by.xpath(` //select[@id="screen"]//option[@value="ButDelete"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="screen"]//option[@value="ButDelete"]`))), delay);
element(by.xpath(` //select[@id="screen"]//option[@value="ButDelete"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="screen"]//option[@value="ButDelete"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="screen"]//option[@value="ButDelete"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="screen"]//option[@value="ButDelete"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="screen"]//option[@value="ButDelete"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="screen"]//option[@value="ButDelete"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\ruleharvestingcount";
                        ...
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="screen"]//option[@value="ButDelete"]`)).click();
