              ...
              describe('vb6', function() {
                    it('callchainpage', function() { 
						console.log('Application_name : vb6, Scenario_name : callchainpage');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\callchainpage";
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-callchainapp/div[3]/div/div[6]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
browser.wait(until.presenceOf(element(by.xpath(`/html/body/app-root/app-layout/section/app-callchainapp/div[1]/app-page-header/div/div/ol/li[1]/a`))), delay, 'Element taking too long to appear in the DOM');
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\callchainpage";
                        var fname="page11.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(`/html/body/app-root/app-layout/section/app-callchainapp/div[1]/app-page-header/div/div/ol/li[1]/a`)).click();
