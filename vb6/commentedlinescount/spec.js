              ...
              describe('vb6', function() {
                    it('commentedlinescount', function() { 
						console.log('Application_name : vb6, Scenario_name : commentedlinescount');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\commentedlinescount";
...
if (assert == `Showing 1 to 10 of 30 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-commentedlinesapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 10 of 30 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-commentedlinesapp/div[4]/div/div/div/div[4] But has Showing 1 to 10 of 30 entries. :Assertion Failed`);
browser.quit();
}
});
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\commentedlinescount";
                        ...
                        stream1.end();});
element(by.xpath(` //button[@id="submitBtn"]`)).click();
element(by.xpath(`/html/body/app-root/app-layout/section/app-commentedlinesapp/div[3]/div[3]/select/option[3]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-commentedlinesapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 2 of 2 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-commentedlinesapp/div[4]/div/div/div/div[4] But has Showing 1 to 2 of 2 entries. :Assertion Failed`);
browser.quit();
}
});
