              ...
              describe('vb6', function() {
                    it('variablepage', function() { 
						console.log('Application_name : vb6, Scenario_name : variablepage');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\variablepage";
...
if (assert.indexOf( `Variable Impact Report`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-impact/div[1]/app-page-header/div/div/ol/li[2] contain Variable Impact Report. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-impact/div[1]/app-page-header/div/div/ol/li[2] But has Variable Impact Report. :Assertion Failed`);
browser.quit();
}
});
...
browser.wait(until.presenceOf(element(by.xpath(`/html/body/app-root/app-layout/section/app-impact/div[1]/app-page-header/div/div/ol/li[1]/a`))), delay, 'Element taking too long to appear in the DOM');
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\variablepage";
                        var fname="page5.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(`/html/body/app-root/app-layout/section/app-impact/div[1]/app-page-header/div/div/ol/li[1]/a`)).click();
