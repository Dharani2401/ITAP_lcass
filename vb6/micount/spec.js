              ...
              describe('vb6', function() {
                    it('micount', function() { 
						console.log('Application_name : vb6, Scenario_name : micount');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\micount";
...
if (assert.indexOf( `30`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[4] contain 30. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[4] But has 30. :Assertion Failed`);
browser.quit();
}
});
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\micount";
                        ...
                        stream1.end();});
element(by.xpath(` //button[@id="submitBtn"]`)).click();
element(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[3]/div[3]/select/option[3]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[4] contain 2. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[4] But has 2. :Assertion Failed`);
browser.quit();
}
});
