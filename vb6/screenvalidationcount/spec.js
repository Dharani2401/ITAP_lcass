              ...
              describe('vb6', function() {
                    it('screenvalidationcount', function() { 
						console.log('Application_name : vb6, Scenario_name : screenvalidationcount');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\screenvalidationcount";
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-cicsvalidation-app/div[4]/div[2]/select/option[2]`)).isPresent().then(function (text) {
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsvalidation-app/div[5]/div[1]/div/div/div[4] is equal toShowing 1 to 2 of 2 entries. :Assertion Passed` );
}else{
...
browser.wait(until.presenceOf(element(by.xpath(` //select[@id="fileln"]//option[@value="PhoneBookingForm.frm"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="fileln"]//option[@value="PhoneBookingForm.frm"]`))), delay);
element(by.xpath(` //select[@id="fileln"]//option[@value="PhoneBookingForm.frm"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="fileln"]//option[@value="PhoneBookingForm.frm"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="fileln"]//option[@value="PhoneBookingForm.frm"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="fileln"]//option[@value="PhoneBookingForm.frm"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="fileln"]//option[@value="PhoneBookingForm.frm"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="fileln"]//option[@value="PhoneBookingForm.frm"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\screenvalidationcount";
                        ...
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="fileln"]//option[@value="PhoneBookingForm.frm"]`)).click();
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\screenvalidationcount";
                        ...
                        stream1.end();});
element(by.xpath(` //button[@id="submitBtn"]`)).click();
element(by.xpath(`/html/body/app-root/app-layout/section/app-cicsvalidation-app/div[4]/div[2]/select/option[3]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-cicsvalidation-app/div[4]/div[4]/select/option[3]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-cicsvalidation-app/div[4]/div[4]/select/option[3] is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-cicsvalidation-app/div[4]/div[4]/select/option[3] is not present in current page. :Assertion Failed`);
browser.quit();
}
});
...
if (assert == `Showing 1 to 10 of 12 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsvalidation-app/div[5]/div[1]/div/div/div[4] is equal toShowing 1 to 10 of 12 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsvalidation-app/div[5]/div[1]/div/div/div[4] But has Showing 1 to 10 of 12 entries. :Assertion Failed`);
browser.quit();
}
});
