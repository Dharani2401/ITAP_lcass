              ...
              describe('vb6', function() {
                    it('crudmultiplelocators', function() { 
						console.log('Application_name : vb6, Scenario_name : crudmultiplelocators');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\crudmultiplelocators";
...
browser.sleep(3000);
var value = element.all(by.className(`ng-tns-c7-2 ng-star-inserted`)).reduce(function(acc, elem) {
...
console.log('Assertion Passed: Expected [READ] got [',assert,']. :Assertion Passed');
}
else{
console.log('Assertion Failed: Expected [READ] got [',assert,']. :Assertion Failed');
}
});
});
