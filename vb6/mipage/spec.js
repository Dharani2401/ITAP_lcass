              ...
              describe('vb6', function() {
                    it('mipage', function() { 
						console.log('Application_name : vb6, Scenario_name : mipage');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\mipage";
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[3]/div[3]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
