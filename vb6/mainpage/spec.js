              ...
              describe('vb6', function() {
                    it('mainpage', function() { 
						console.log('Application_name : vb6, Scenario_name : mainpage');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\mainpage";
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-dashboard/div[1]/h2`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
