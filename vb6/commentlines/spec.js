              ...
              describe('vb6', function() {
                    it('commentlines', function() { 
						console.log('Application_name : vb6, Scenario_name : commentlines');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\commentlines";
