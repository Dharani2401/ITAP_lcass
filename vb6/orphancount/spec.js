              ...
              describe('vb6', function() {
                    it('orphancount', function() { 
						console.log('Application_name : vb6, Scenario_name : orphancount');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\orphancount";
...
browser.wait(until.presenceOf(element.all(by.xpath(`//a`)).get(23)), delay, 'Element taking too long to appear in the DOM');

browser.wait(until.elementToBeClickable(element.all(by.xpath(`//a`)).get(23)), delay);
element.all(by.xpath(`//a`)).get(23).getText().then(function(text){
var description =''; 
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(`//a[23]`, text);
    }
else
    {
    Get_Text.set(`//a[23]`, text[0]);
    }  
});
element.all(by.xpath(`//a`)).get(23).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//a[23]`, text);
    }
else
    {
    Get_Attribute.set(`//a[23]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\orphancount";
                        ...
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element.all(by.xpath(`//a`)).get(23).click();
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[3]/div[3]/select/option[2]`)).isPresent().then(function (text) {
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\orphancount";
                        ...
                        stream1.end();});
element(by.xpath(` //button[@id="submitBtn"]`)).click();
element(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[3]/div[3]/select/option[7]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-orphanapp/div[3]/div[3]/select/option[7] is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-orphanapp/div[3]/div[3]/select/option[7] is not present in current page. :Assertion Failed`);
browser.quit();
}
});
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 6 of 6 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[4] But has Showing 1 to 6 of 6 entries. :Assertion Failed`);
browser.quit();
}
});
