              ...
              describe('vb6', function() {
                    it('crudcount', function() { 
						console.log('Application_name : vb6, Scenario_name : crudcount');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\crudcount";
...
if (assert == `Showing 1 to 10 of 111 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-formapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 10 of 111 entries. :Assertion Passed` );
}else{
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\crudcount";
                        ...
                        stream1.end();});
element(by.xpath(` //button[@id="submitBtn"]`)).click();
element(by.xpath(`/html/body/app-root/app-layout/section/app-formapp/div[3]/div[3]/select/option[3]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
if (assert == `Showing 1 to 10 of 18 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-formapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 10 of 18 entries. :Assertion Passed` );
}else{
