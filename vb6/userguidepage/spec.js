              ...
              describe('vb6', function() {
                    it('userguidepage', function() { 
						console.log('Application_name : vb6, Scenario_name : userguidepage');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\userguidepage";
...
var assert='';
element(by.xpath(`/html/body/app-root/app-layout/section/app-charts/pdf-viewer/div/div/div[1]/div[2]/span[1]`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if (assert == `Tech Mahindra `){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-charts/pdf-viewer/div/div/div[1]/div[2]/span[1] is equal toTech Mahindra . :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-charts/pdf-viewer/div/div/div[1]/div[2]/span[1] But has Tech Mahindra . :Assertion Failed`);
browser.quit();
}
});
