              ...
              describe('vb6', function() {
                    it('processflowpage', function() { 
						console.log('Application_name : vb6, Scenario_name : processflowpage');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\processflowpage";
...
browser.wait(until.presenceOf(element(by.xpath(` //select[@id="extCall"]//option[@value="Command1_Click"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="extCall"]//option[@value="Command1_Click"]`))), delay);
element(by.xpath(` //select[@id="extCall"]//option[@value="Command1_Click"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="extCall"]//option[@value="Command1_Click"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="extCall"]//option[@value="Command1_Click"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="extCall"]//option[@value="Command1_Click"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="extCall"]//option[@value="Command1_Click"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="extCall"]//option[@value="Command1_Click"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\processflowpage";
                        ...
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="extCall"]//option[@value="Command1_Click"]`)).click();
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-programprocessflowext/div[6]/div[4]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-programprocessflowext/div[6]/div[5]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-programprocessflowext/div[6]/div[5]/button is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-programprocessflowext/div[6]/div[5]/button is not present in current page. :Assertion Failed`);
browser.quit();
}
});
