              ...
              describe('vb6', function() {
                    it('sankeypage', function() { 
						console.log('Application_name : vb6, Scenario_name : sankeypage');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\sankeypage";
...
if (assert.indexOf( `Sankey Diagram`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-sankey/div[1]/app-page-header/div/div/ol/li[2] contain Sankey Diagram. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-sankey/div[1]/app-page-header/div/div/ol/li[2] But has Sankey Diagram. :Assertion Failed`);
browser.quit();
}
});
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-sankey/div[2]/div[5]/button`)).isEnabled().then(function(text){
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if(assert==true)
    {
    console.log(`Assertion Passed:  /html/body/app-root/app-layout/section/app-sankey/div[2]/div[5]/button is enabled. :Assertion Passed`);
    }
if(assert==false)
    {
    console.log(`Assertion Failed: /html/body/app-root/app-layout/section/app-sankey/div[2]/div[5]/button is disabled. :Assertion Failed`);
    browser.quit();
    }
});
