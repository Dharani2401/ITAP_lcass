              ...
              describe('vb6', function() {
                    it('screenfieldcount', function() { 
						console.log('Application_name : vb6, Scenario_name : screenfieldcount');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\screenfieldcount";
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[2]/select/option[2]`)).isPresent().then(function (text) {
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[4]/select/option[3]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[4]/select/option[3] is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[4]/select/option[3] is not present in current page. :Assertion Failed`);
browser.quit();
}
});
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[5]/div[1]/div/div/div[4] is equal toShowing 1 to 10 of 34 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[5]/div[1]/div/div/div[4] But has Showing 1 to 10 of 34 entries. :Assertion Failed`);
browser.quit();
}
});
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\screenfieldcount";
                        ...
                        stream1.end();});
element(by.xpath(` //button[@id="submitBtn"]`)).click();
element(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[2]/select/option[3]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
if (assert == `Showing 1 to 9 of 9 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[5]/div[1]/div/div/div[4] is equal toShowing 1 to 9 of 9 entries. :Assertion Passed` );
}else{
