              ...
              describe('vb6', function() {
                    it('testcollapse', function() { 
						console.log('Application_name : vb6, Scenario_name : testcollapse');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\testcollapse";
...
element.all(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[2]/i`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/app-sidebar/nav/div[2]/i is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/app-sidebar/nav/div[2]/i is not present in current page. :Assertion Failed`);
browser.quit();
}
});
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\testcollapse";
                        ...
                        stream1.end();});
element(by.xpath(` //i[@id="collapseExpand"]`)).click();
element.all(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[2]/span`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/app-sidebar/nav/div[2]/span is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/app-sidebar/nav/div[2]/span is not present in current page. :Assertion Failed`);
browser.quit();
}
});
});
