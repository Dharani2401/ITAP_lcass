              ...
              describe('vb6', function() {
                    it('minamecheck', function() { 
						console.log('Application_name : vb6, Scenario_name : minamecheck');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\minamecheck";
