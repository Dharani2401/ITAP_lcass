              ...
              describe('vb6', function() {
                    it('orphanreport', function() { 
						console.log('Application_name : vb6, Scenario_name : orphanreport');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\orphanreport";
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr/td`)).getText().then(function (text) {
if( typeof text ==='object')
    {
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr/td contain no data available in table. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr/td But has no data available in table. :Assertion Failed`);
browser.quit();
}
});
...
browser.sleep(3000);var assert='';
element(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0].toLowerCase();
    }
...
if (assert.indexOf( `customer`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr contain customer. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr But has customer. :Assertion Failed`);
browser.quit();
}
});
...
if (assert.indexOf( `main`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr contain main. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr But has main. :Assertion Failed`);
browser.quit();
}
});
...
browser.sleep(3000);var assert='';
element(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr[1]`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0].toLowerCase();
    }
...
if (assert.indexOf( `purchase`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr[1] contain purchase. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr[1] But has purchase. :Assertion Failed`);
browser.quit();
}
});
