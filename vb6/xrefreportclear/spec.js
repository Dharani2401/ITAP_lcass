              ...
              describe('vb6', function() {
                    it('xrefreportclear', function() { 
						console.log('Application_name : vb6, Scenario_name : xrefreportclear');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\xrefreportclear";
...
console.log('test_step_inputbooking');});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\xrefreportclear";
                        var fname="page7.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //input[@id="searchFilter"]`)).sendKeys(`booking`);
