              ...
              describe('vb6', function() {
                    it('xrefcount', function() { 
						console.log('Application_name : vb6, Scenario_name : xrefcount');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\xrefcount";
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-x-ref-application/div[3]/div[3]/select/option[2]`)).isPresent().then(function (text) {
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\xrefcount";
                        ...
                        stream1.end();});
element(by.xpath(` //button[@id="submitBtn"]`)).click();
element(by.xpath(`/html/body/app-root/app-layout/section/app-x-ref-application/div[3]/div[3]/select/option[3]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
if (assert.indexOf( `5`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-x-ref-application/div[4]/div[5]/label contain 5. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-x-ref-application/div[4]/div[5]/label But has 5. :Assertion Failed`);
browser.quit();
}
});
