              ...
              describe('vb6', function() {
                    it('buttons', function() { 
						console.log('Application_name : vb6, Scenario_name : buttons');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\buttons";
...
browser.sleep(3000);element(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[5]/a[2]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
browser.sleep(3000);element(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[5]/a[3]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
browser.sleep(3000);element(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[5]/a[4]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
