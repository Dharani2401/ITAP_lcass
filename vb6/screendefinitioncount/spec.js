              ...
              describe('vb6', function() {
                    it('screendefinitioncount', function() { 
						console.log('Application_name : vb6, Scenario_name : screendefinitioncount');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\screendefinitioncount";
...
browser.wait(until.presenceOf(element(by.xpath(` //select[@id="fileln"]//option[@value="CustomerListReport.frm"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="fileln"]//option[@value="CustomerListReport.frm"]`))), delay);
element(by.xpath(` //select[@id="fileln"]//option[@value="CustomerListReport.frm"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="fileln"]//option[@value="CustomerListReport.frm"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="fileln"]//option[@value="CustomerListReport.frm"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="fileln"]//option[@value="CustomerListReport.frm"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="fileln"]//option[@value="CustomerListReport.frm"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="fileln"]//option[@value="CustomerListReport.frm"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\screendefinitioncount";
                        ...
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="fileln"]//option[@value="CustomerListReport.frm"]`)).click();
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[2]/select/option[4]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[2]/select/option[4] is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[2]/select/option[4] is not present in current page. :Assertion Failed`);
browser.quit();
}
});
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[5]/div[1]/div/div/div[4] is equal toShowing 1 to 6 of 6 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[5]/div[1]/div/div/div[4] But has Showing 1 to 6 of 6 entries. :Assertion Failed`);
browser.quit();
}
});
...
browser.wait(until.presenceOf(element(by.xpath(` //select[@id="fileln"]//option[@value="EmpForm.frm"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="fileln"]//option[@value="EmpForm.frm"]`))), delay);
element(by.xpath(` //select[@id="fileln"]//option[@value="EmpForm.frm"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="fileln"]//option[@value="EmpForm.frm"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="fileln"]//option[@value="EmpForm.frm"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="fileln"]//option[@value="EmpForm.frm"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="fileln"]//option[@value="EmpForm.frm"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="fileln"]//option[@value="EmpForm.frm"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\screendefinitioncount";
                        ...
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="fileln"]//option[@value="EmpForm.frm"]`)).click();
...
browser.sleep(3000);element(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[2]/select/option[5]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[2]/select/option[5] is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[2]/select/option[5] is not present in current page. :Assertion Failed`);
browser.quit();
}
});
element(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[4]/select/option[2]`)).isPresent().then(function (text) {
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[5]/div[1]/div/div/div[4] is equal toShowing 1 to 10 of 22 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[5]/div[1]/div/div/div[4] But has Showing 1 to 10 of 22 entries. :Assertion Failed`);
browser.quit();
}
});
});
