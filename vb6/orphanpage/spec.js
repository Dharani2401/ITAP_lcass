              ...
              describe('vb6', function() {
                    it('orphanpage', function() { 
						console.log('Application_name : vb6, Scenario_name : orphanpage');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\orphanpage";
...
var assert='';
element(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[1]/div/table/thead/tr/th[1]`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[1]/div/table/thead/tr/th[1] is equal toCOMPONENT_NAME. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[1]/div/table/thead/tr/th[1] But has COMPONENT_NAME. :Assertion Failed`);
browser.quit();
}
});

var assert='';
element(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[1]/div/table/thead/tr/th[2]`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[1]/div/table/thead/tr/th[2] is equal toCOMPONENT_TYPE. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[1]/div/table/thead/tr/th[2] But has COMPONENT_TYPE. :Assertion Failed`);
browser.quit();
}
});

var assert='';
element(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[1]/div/table/thead/tr/th[3]`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[1]/div/table/thead/tr/th[3] is equal toAPPLICATION. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[1]/div/table/thead/tr/th[3] But has APPLICATION. :Assertion Failed`);
browser.quit();
}
});
var assert='';
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[4] contain Showing 1 to 8 of 8 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[4] But has Showing 1 to 8 of 8 entries. :Assertion Failed`);
browser.quit();
}
});

var assert='';
element(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[5]/a[1]`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if (assert == `First`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[5]/a[1] is equal toFirst. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[5]/a[1] But has First. :Assertion Failed`);
browser.quit();
}
});

var assert='';
element(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[5]/a[4]`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if (assert == `Last`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[5]/a[4] is equal toLast. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[5]/a[4] But has Last. :Assertion Failed`);
browser.quit();
}
});
