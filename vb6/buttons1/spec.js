              ...
              describe('vb6', function() {
                    it('buttons1', function() { 
						console.log('Application_name : vb6, Scenario_name : buttons1');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\buttons1";
...
browser.sleep(3000);element(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[5]/span/a[1]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[5]/span/a[1] is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[5]/span/a[1] is not present in current page. :Assertion Failed`);
browser.quit();
}
});
...
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[5]/span/a[2] is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[5]/span/a[2] is not present in current page. :Assertion Failed`);
browser.quit();
}
});
...
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[5]/span/a[3] is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[5]/span/a[3] is not present in current page. :Assertion Failed`);
browser.quit();
}
});
});
