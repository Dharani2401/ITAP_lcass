              ...
              describe('vb6', function() {
                    it('variable', function() { 
						console.log('Application_name : vb6, Scenario_name : variable');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\variable";
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-impact/div[3]/div[6]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
