              ...
              describe('vb6', function() {
                    it('screenfieldpage', function() { 
						console.log('Application_name : vb6, Scenario_name : screenfieldpage');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\vb6\\screenfieldpage";
...
var assert='';
element(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[3]/label`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if (assert == `File Name: `){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[3]/label is equal toFile Name: . :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[3]/label But has File Name: . :Assertion Failed`);
browser.quit();
}
});
