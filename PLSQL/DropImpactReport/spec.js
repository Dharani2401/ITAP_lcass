...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\PLSQL\\DropImpactReport";
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-dropimpactapp/div[4]/div/div/div/div[1]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-dropimpactapp/div[4]/div/div/div/div[1] is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-dropimpactapp/div[4]/div/div/div/div[1] is not present in current page. :Assertion Failed`);
browser.quit();
}
});
element(by.xpath(`/html/body/app-root/app-layout/section/app-dropimpactapp/div[4]/div/div/div/div[2]/label/input`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
