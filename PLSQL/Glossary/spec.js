...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\PLSQL\\Glossary";
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[4]/div[1]/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
