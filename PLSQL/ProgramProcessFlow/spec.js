...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\PLSQL\\ProgramProcessFlow";
...
browser.sleep(1000);element(by.xpath(`/html/body/app-root/app-layout/section/app-programprocessflow/div[4]/div[2]/select`)).isPresent().then(function (text) {
