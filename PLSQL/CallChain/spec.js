...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\PLSQL\\CallChain";
...
browser.sleep(1000);element(by.xpath(`/html/body/app-root/app-layout/section/app-callchain-plsql-app/div[2]/div/div[2]/select`)).isPresent().then(function (text) {
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-callchain-plsql-app/div[3]/div/div[4]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-callchain-plsql-app/div[3]/div/div[4]/select is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-callchain-plsql-app/div[3]/div/div[4]/select is not present in current page. :Assertion Failed`);
browser.quit();
}
});
