...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\PLSQL\\DetailedReport";
...
browser.sleep(1000);element(by.xpath(`/html/body/app-root/app-layout/section/app-breplsql-app/div[3]/div/div[2]/select`)).isPresent().then(function (text) {
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-breplsql-app/div[7]/div/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-breplsql-app/div[7]/div/div/div/div[3]/div[1]/div/table is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-breplsql-app/div[7]/div/div/div/div[3]/div[1]/div/table is not present in current page. :Assertion Failed`);
browser.quit();
}
});
