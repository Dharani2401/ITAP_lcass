...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\PLSQL\\MissingComponent";
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-missingcompapp/div[3]/div/div/div/div[2]/label/input`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
