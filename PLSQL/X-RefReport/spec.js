...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\PLSQL\\X-RefReport";
...
browser.sleep(1000);element(by.xpath(`/html/body/app-root/app-layout/section/app-x-ref-application/div[3]/div[3]/select`)).isPresent().then(function (text) {
