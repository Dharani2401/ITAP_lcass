...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\PLSQL\\OrphanReport";
...
browser.sleep(1000);element(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[3]/div[3]/select`)).isPresent().then(function (text) {
