...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\PLSQL\\ColorCheck";
...
var assert='';
element(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[3]/div[4]/button`)).getCssValue('color').then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[3]/div[4]/button containsrgba(255. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[3]/div[4]/button not contain rgba(255. :Assertion Failed`);
browser.quit();
}
});
});
