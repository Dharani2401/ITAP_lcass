...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\PLSQL\\FileDownload";
...
var download_directory= `C:\\Users\\es00780451\\Downloads\\`;
...
if(sorted_files[sorted_files.length-1].includes(`Master Inventory Report_export_1650355723288`)){
console.log("Assertion Passed: Expected file containing  Master Inventory Report_export_1650355723288 in it's filename ",sorted_files[sorted_files.length-1]," is downloaded. :Assertion Passed");
}else{
console.log('Assertion Failed: Expected file with the filename containing Master Inventory Report_export_1650355723288 is not downloaded. :Assertion Failed');
browser.quit();
}
});
