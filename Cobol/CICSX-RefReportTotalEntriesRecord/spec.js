              ...
              describe('Cobol', function() {
                    it('CICSX-RefReportTotalEntriesRecord', function() { 
						console.log('Application_name : Cobol, Scenario_name : CICSX-RefReportTotalEntriesRecord');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\Cobol\\CICSX-RefReportTotalEntriesRecord";
...
browser.sleep(5000);element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/div[3]/li/ul/li[3]/a`)).isPresent().then(function (text) {
console.log("presence");
var assert='';
if (text == true){
console.log('xpath in same page');
element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/div[3]/li/ul/li[3]/a`)).getText().then(function (text){
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if(`getText()`=="getText()"){
assert=Get_Text.get(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/div[3]/li/ul/li[3]/a`)  }
if(`getText()`=="getAttribute('value')"){
assert=Get_Attribute.get(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/div[3]/li/ul/li[3]/a`)  }
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-cics-x-ref-app/div[1]/app-page-header/div/div/ol/li[2]`)).getText().then(function (text) {
var assert1='';
if( typeof text ==='object')
    {
    assert1=text[0];
...
console.log('Assertion Passed: Expected', assert1, `for the Xpath/html/body/app-root/app-layout/section/app-cics-x-ref-app/div[1]/app-page-header/div/div/ol/li[2] contain `, assert, '. :Assertion Passed');
}else{
console.log('Assertion Failed: Expected', assert1, `for the Xpath/html/body/app-root/app-layout/section/app-cics-x-ref-app/div[1]/app-page-header/div/div/ol/li[2] But has`, assert , '. :Assertion Failed');
browser.quit();
}
});
});
...
var assert='';
element(by.xpath(`/html/body/app-root/app-layout/section/app-cics-x-ref-app/div[4]/div[5]/label`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if (assert == `Total no of records: 21`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cics-x-ref-app/div[4]/div[5]/label is equal toTotal no of records: 21. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cics-x-ref-app/div[4]/div[5]/label But has Total no of records: 21. :Assertion Failed`);
browser.quit();
}
});
