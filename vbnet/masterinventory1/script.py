...
try:
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\vbnet\masterinventory1\page1.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\vbnet\masterinventory1\page2.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\vbnet\masterinventory1\page3.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\vbnet\masterinventory1\page4.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\vbnet\masterinventory1\page5.png')
    msg_count=0
    pass_count=0
    fail_count=0
    if len(a)>=1:
    ...
    with open(r"D:\iTAP\Recorded_Scenarios\vbnet\masterinventory1\logfile.log", "w+") as external_file:
    ...
    path = open(r"D:\iTAP\Recorded_Scenarios\vbnet\masterinventory1\logfile.log", "w+")
