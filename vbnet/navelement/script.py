...
try:
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\vbnet\navelement\page1.png')
    ...
    with open(r"D:\iTAP\Recorded_Scenarios\vbnet\navelement\logfile.log", "w+") as external_file:
    ...
    path = open(r"D:\iTAP\Recorded_Scenarios\vbnet\navelement\logfile.log", "w+")
