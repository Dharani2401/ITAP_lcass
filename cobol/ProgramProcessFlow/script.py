...
try:
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\Cobol\ProgramProcessFlow\page1.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\Cobol\ProgramProcessFlow\page2.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\Cobol\ProgramProcessFlow\page3.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\Cobol\ProgramProcessFlow\page4.png')
    ...
    driver.save_screenshot(r'D:\iTAP\Recorded_Scenarios\Cobol\ProgramProcessFlow\page5.png')
    msg_count=0
    pass_count=0
    fail_count=0
    if len(a)>=1:
    ...
    with open(r"D:\iTAP\Recorded_Scenarios\Cobol\ProgramProcessFlow\logfile.log", "w+") as external_file:
    ...
    path = open(r"D:\iTAP\Recorded_Scenarios\Cobol\ProgramProcessFlow\logfile.log", "w+")
