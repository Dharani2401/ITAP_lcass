              ...
              describe('AS400', function() {
                    it('DeadReportTotalEntriesRecord', function() { 
						console.log('Application_name : AS400, Scenario_name : DeadReportTotalEntriesRecord');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\DeadReportTotalEntriesRecord";
...
browser.sleep(5000);element(by.xpath(`/html/body/app-root/app-layout/section/app-deadparaapp/div[1]/app-page-header/div/div/ol/li[2]`)).isPresent().then(function (text) {
...
if(`getText()`=="getText()"){
assert=Get_Text.get(`/html/body/app-root/app-layout/section/app-deadparaapp/div[1]/app-page-header/div/div/ol/li[2]`)  }
if(`getText()`=="getAttribute('value')"){
assert=Get_Attribute.get(`/html/body/app-root/app-layout/section/app-deadparaapp/div[1]/app-page-header/div/div/ol/li[2]`)  }
...
element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/div[3]/li/ul/li[3]/a/span`)).getText().then(function (text) {
var assert1='';
if( typeof text ==='object')
    {
    assert1=text[0];
...
console.log('Assertion Passed: Expected', assert1, `for the Xpath/html/body/app-root/app-layout/app-sidebar/nav/div[1]/div[3]/li/ul/li[3]/a/span contain `, assert, '. :Assertion Passed');
}else{
console.log('Assertion Failed: Expected', assert1, `for the Xpath/html/body/app-root/app-layout/app-sidebar/nav/div[1]/div[3]/li/ul/li[3]/a/span But has`, assert , '. :Assertion Failed');
browser.quit();
}
});
});
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 6 of 6 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[4] But has Showing 1 to 6 of 6 entries. :Assertion Failed`);
browser.quit();
}
});
