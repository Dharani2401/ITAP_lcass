              ...
              describe('AS400', function() {
                    it('MasterInventoryTest', function() { 
						console.log('Application_name : AS400, Scenario_name : MasterInventoryTest');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\MasterInventoryTest";
...
browser.sleep(2000);element(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[3]/div[3]/select`)).isPresent().then(function (text) {
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
