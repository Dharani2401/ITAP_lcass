              ...
              describe('AS400', function() {
                    it('RuleCategory', function() { 
						console.log('Application_name : AS400, Scenario_name : RuleCategory');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\RuleCategory";
...
browser.sleep(1000);element(by.xpath(`/html/body/app-root/app-layout/section/app-bre3/div[3]/div[3]/select`)).isPresent().then(function (text) {
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-bre3/div[4]/div[7]/a/img`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
