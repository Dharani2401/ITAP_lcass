              ...
              describe('AS400', function() {
                    it('CRUDTotalEntriesRecord', function() { 
						console.log('Application_name : AS400, Scenario_name : CRUDTotalEntriesRecord');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\CRUDTotalEntriesRecord";
...
if (assert == `Showing 1 to 10 of 668 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-formapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 10 of 668 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-formapp/div[4]/div/div/div/div[4] But has Showing 1 to 10 of 668 entries. :Assertion Failed`);
browser.quit();
}
});
...
if (assert == `Showing 1 to 10 of 451 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-formapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 10 of 451 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-formapp/div[4]/div/div/div/div[4] But has Showing 1 to 10 of 451 entries. :Assertion Failed`);
browser.quit();
}
});
