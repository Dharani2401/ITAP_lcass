              ...
              describe('AS400', function() {
                    it('X-RefReport', function() { 
						console.log('Application_name : AS400, Scenario_name : X-RefReport');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\X-RefReport";
...
browser.sleep(2000);element(by.xpath(`/html/body/app-root/app-layout/section/app-x-ref-application/div[3]/div[3]/select`)).isPresent().then(function (text) {
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-x-ref-application/div[4]/div[8]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-x-ref-application/div[4]/div[8]/div/table is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-x-ref-application/div[4]/div[8]/div/table is not present in current page. :Assertion Failed`);
browser.quit();
}
});
