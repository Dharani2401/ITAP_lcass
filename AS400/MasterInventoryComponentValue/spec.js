              ...
              describe('AS400', function() {
                    it('MasterInventoryComponentValue', function() { 
						console.log('Application_name : AS400, Scenario_name : MasterInventoryComponentValue');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\MasterInventoryComponentValue";
...
console.log(assert);
if (assert1 == assert){
console.log('Assertion Passed: Expected', assert1, `for the Xpath//td is equal to`, assert ,'. :Assertion Passed');
}else{
