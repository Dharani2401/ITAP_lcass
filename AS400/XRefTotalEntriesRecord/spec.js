              ...
              describe('AS400', function() {
                    it('XRefTotalEntriesRecord', function() { 
						console.log('Application_name : AS400, Scenario_name : XRefTotalEntriesRecord');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\XRefTotalEntriesRecord";
...
if (assert == `Total no of records: 727`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-x-ref-application/div[4]/div[5]/label is equal toTotal no of records: 727. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-x-ref-application/div[4]/div[5]/label But has Total no of records: 727. :Assertion Failed`);
browser.quit();
}
});
...
if (assert == `Total no of records: 418`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-x-ref-application/div[4]/div[5]/label is equal toTotal no of records: 418. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-x-ref-application/div[4]/div[5]/label But has Total no of records: 418. :Assertion Failed`);
browser.quit();
}
});
