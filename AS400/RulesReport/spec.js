              ...
              describe('AS400', function() {
                    it('RulesReport', function() { 
						console.log('Application_name : AS400, Scenario_name : RulesReport');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\RulesReport";
...
browser.sleep(1000);element(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[5]/div[2]/select`)).isPresent().then(function (text) {
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[5]/div[4]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[7]/div/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
