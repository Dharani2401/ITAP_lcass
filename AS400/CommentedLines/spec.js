              ...
              describe('AS400', function() {
                    it('CommentedLines', function() { 
						console.log('Application_name : AS400, Scenario_name : CommentedLines');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\CommentedLines";
