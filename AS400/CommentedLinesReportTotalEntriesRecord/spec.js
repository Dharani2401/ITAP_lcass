              ...
              describe('AS400', function() {
                    it('CommentedLinesReportTotalEntriesRecord', function() { 
						console.log('Application_name : AS400, Scenario_name : CommentedLinesReportTotalEntriesRecord');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\CommentedLinesReportTotalEntriesRecord";
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-commentedlinesapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 6 of 6 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-commentedlinesapp/div[4]/div/div/div/div[4] But has Showing 1 to 6 of 6 entries. :Assertion Failed`);
browser.quit();
}
});
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-commentedlinesapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 4 of 4 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-commentedlinesapp/div[4]/div/div/div/div[4] But has Showing 1 to 4 of 4 entries. :Assertion Failed`);
browser.quit();
}
});
