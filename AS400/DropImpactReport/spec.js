              ...
              describe('AS400', function() {
                    it('DropImpactReport', function() { 
						console.log('Application_name : AS400, Scenario_name : DropImpactReport');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\DropImpactReport";
...
browser.sleep(1000);element(by.xpath(`/html/body/app-root/app-layout/section/app-dropimpactapp/div[3]/div[3]/select`)).isPresent().then(function (text) {
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-dropimpactapp/div[4]/div/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
