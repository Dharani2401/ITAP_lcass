              ...
              describe('AS400', function() {
                    it('RulesReportShowCodeEnableCheck', function() { 
						console.log('Application_name : AS400, Scenario_name : RulesReportShowCodeEnableCheck');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\RulesReportShowCodeEnableCheck";
