              ...
              describe('AS400', function() {
                    it('ForwardCallChain', function() { 
						console.log('Application_name : AS400, Scenario_name : ForwardCallChain');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\ForwardCallChain";
...
browser.wait(until.presenceOf(element(by.xpath(` //a[@href="/as400/callChainApp"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //a[@href="/as400/callChainApp"]`))), delay);
element(by.xpath(` //a[@href="/as400/callChainApp"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //a[@href="/as400/callChainApp"]`, text);
    }
else
    {
    Get_Text.set(` //a[@href="/as400/callChainApp"]`, text[0]);
    }  
});
element.all(by.xpath(` //a[@href="/as400/callChainApp"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//a[@href="/as400/callChainApp"]`, text);
    }
else
    {
    Get_Attribute.set(` //a[@href="/as400/callChainApp"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\ForwardCallChain";
                        ...
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //a[@href="/as400/callChainApp"]`)).click();
...
browser.wait(until.presenceOf(element(by.xpath(` //select[@id="cmp"]//option[@value="Bound procedure"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="cmp"]//option[@value="Bound procedure"]`))), delay);
element(by.xpath(` //select[@id="cmp"]//option[@value="Bound procedure"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="cmp"]//option[@value="Bound procedure"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="cmp"]//option[@value="Bound procedure"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="cmp"]//option[@value="Bound procedure"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="cmp"]//option[@value="Bound procedure"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="cmp"]//option[@value="Bound procedure"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\ForwardCallChain";
                        ...
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="cmp"]//option[@value="Bound procedure"]`)).click();

browser.wait(until.presenceOf(element(by.xpath(` //select[@id="cmpName"]//option[@value="IPCHKSUSP"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="cmpName"]//option[@value="IPCHKSUSP"]`))), delay);
element(by.xpath(` //select[@id="cmpName"]//option[@value="IPCHKSUSP"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="cmpName"]//option[@value="IPCHKSUSP"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="cmpName"]//option[@value="IPCHKSUSP"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="cmpName"]//option[@value="IPCHKSUSP"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="cmpName"]//option[@value="IPCHKSUSP"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="cmpName"]//option[@value="IPCHKSUSP"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\ForwardCallChain";
                        ...
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="cmpName"]//option[@value="IPCHKSUSP"]`)).click();
