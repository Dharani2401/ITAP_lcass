              ...
              describe('AS400', function() {
                    it('SankeyDiagram', function() { 
						console.log('Application_name : AS400, Scenario_name : SankeyDiagram');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\SankeyDiagram";
...
browser.sleep(1000);element(by.xpath(`/html/body/app-root/app-layout/section/app-sankey/div[2]/div[2]/select`)).isPresent().then(function (text) {
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-sankey/div[2]/div[4]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
