              ...
              describe('AS400', function() {
                    it('OrphanReportTotalEntriesRecord', function() { 
						console.log('Application_name : AS400, Scenario_name : OrphanReportTotalEntriesRecord');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\OrphanReportTotalEntriesRecord";
...
browser.wait(until.presenceOf(element(by.xpath(` //a[@href="/as400/orphanApplication"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //a[@href="/as400/orphanApplication"]`))), delay);
element(by.xpath(` //a[@href="/as400/orphanApplication"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //a[@href="/as400/orphanApplication"]`, text);
    }
else
    {
    Get_Text.set(` //a[@href="/as400/orphanApplication"]`, text[0]);
    }  
});
element.all(by.xpath(` //a[@href="/as400/orphanApplication"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//a[@href="/as400/orphanApplication"]`, text);
    }
else
    {
    Get_Attribute.set(` //a[@href="/as400/orphanApplication"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\OrphanReportTotalEntriesRecord";
                        ...
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //a[@href="/as400/orphanApplication"]`)).click();
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 8 of 8 entries. :Assertion Passed` );
}else{
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 3 of 3 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[4] But has Showing 1 to 3 of 3 entries. :Assertion Failed`);
browser.quit();
}
});
