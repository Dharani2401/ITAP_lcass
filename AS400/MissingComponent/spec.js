              ...
              describe('AS400', function() {
                    it('MissingComponent', function() { 
						console.log('Application_name : AS400, Scenario_name : MissingComponent');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\MissingComponent";
...
browser.sleep(1000);element(by.xpath(`/html/body/app-root/app-layout/section/app-missingcompapp/div[2]/div[3]/select`)).isPresent().then(function (text) {
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-missingcompapp/div[3]/div/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
