              ...
              describe('AS400', function() {
                    it('ControlFlow', function() { 
						console.log('Application_name : AS400, Scenario_name : ControlFlow');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\ControlFlow";
...
browser.sleep(1000);element(by.xpath(`/html/body/app-root/app-layout/section/app-controlflowapp/div[2]/div/div[2]/select`)).isPresent().then(function (text) {
