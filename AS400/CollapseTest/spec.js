              ...
              describe('AS400', function() {
                    it('CollapseTest', function() { 
						console.log('Application_name : AS400, Scenario_name : CollapseTest');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\CollapseTest";
...
var assert='';
element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[2]/i`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/app-sidebar/nav/div[2]/i and has same value Collapse Sidebar. :Assertion Failed`);
browser.quit();
}else{
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/app-sidebar/nav/div[2]/i contain Collapse Sidebar. :Assertion Passed` );
}
});
