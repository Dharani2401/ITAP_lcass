              ...
              describe('AS400', function() {
                    it('Glossary', function() { 
						console.log('Application_name : AS400, Scenario_name : Glossary');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\Glossary";
...
browser.sleep(1000);element(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[3]/div[2]/input`)).isPresent().then(function (text) {
