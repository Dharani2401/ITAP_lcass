              ...
              describe('AS400', function() {
                    it('NotPresence', function() { 
						console.log('Application_name : AS400, Scenario_name : NotPresence');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\NotPresence";
