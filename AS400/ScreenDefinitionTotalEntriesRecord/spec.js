              ...
              describe('AS400', function() {
                    it('ScreenDefinitionTotalEntriesRecord', function() { 
						console.log('Application_name : AS400, Scenario_name : ScreenDefinitionTotalEntriesRecord');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\ScreenDefinitionTotalEntriesRecord";
...
browser.wait(until.presenceOf(element(by.xpath(` //select[@id="fileln"]//option[@value="TSGPDTWD"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="fileln"]//option[@value="TSGPDTWD"]`))), delay);
element(by.xpath(` //select[@id="fileln"]//option[@value="TSGPDTWD"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="fileln"]//option[@value="TSGPDTWD"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="fileln"]//option[@value="TSGPDTWD"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="fileln"]//option[@value="TSGPDTWD"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="fileln"]//option[@value="TSGPDTWD"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="fileln"]//option[@value="TSGPDTWD"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\ScreenDefinitionTotalEntriesRecord";
                        ...
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="fileln"]//option[@value="TSGPDTWD"]`)).click();
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[5]/div[1]/div/div/div[4] is equal toShowing 1 to 5 of 5 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[5]/div[1]/div/div/div[4] But has Showing 1 to 5 of 5 entries. :Assertion Failed`);
browser.quit();
}
});

browser.wait(until.presenceOf(element(by.xpath(` //select[@id="fileln"]//option[@value="TSSKYEVTD"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="fileln"]//option[@value="TSSKYEVTD"]`))), delay);
element(by.xpath(` //select[@id="fileln"]//option[@value="TSSKYEVTD"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="fileln"]//option[@value="TSSKYEVTD"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="fileln"]//option[@value="TSSKYEVTD"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="fileln"]//option[@value="TSSKYEVTD"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="fileln"]//option[@value="TSSKYEVTD"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="fileln"]//option[@value="TSSKYEVTD"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\ScreenDefinitionTotalEntriesRecord";
                        ...
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="fileln"]//option[@value="TSSKYEVTD"]`)).click();
...
if (assert == `Showing 1 to 10 of 87 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[5]/div[1]/div/div/div[4] is equal toShowing 1 to 10 of 87 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-app/div[5]/div[1]/div/div/div[4] But has Showing 1 to 10 of 87 entries. :Assertion Failed`);
browser.quit();
}
});
