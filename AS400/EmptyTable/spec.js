              ...
              describe('AS400', function() {
                    it('EmptyTable', function() { 
						console.log('Application_name : AS400, Scenario_name : EmptyTable');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\EmptyTable";
