              ...
              describe('AS400', function() {
                    it('DropImpactReportTotalEntriesRecord', function() { 
						console.log('Application_name : AS400, Scenario_name : DropImpactReportTotalEntriesRecord');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\DropImpactReportTotalEntriesRecord";
...
if (assert == `Showing 1 to 10 of 328 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-dropimpactapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 10 of 328 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-dropimpactapp/div[4]/div/div/div/div[4] But has Showing 1 to 10 of 328 entries. :Assertion Failed`);
browser.quit();
}
});
