              ...
              describe('AS400', function() {
                    it('DetailedReportTotalEntriesRecord', function() { 
						console.log('Application_name : AS400, Scenario_name : DetailedReportTotalEntriesRecord');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\DetailedReportTotalEntriesRecord";
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[4] contain Showing 1 to 10 of 3. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[4] But has Showing 1 to 10 of 3. :Assertion Failed`);
browser.quit();
}
});
