              ...
              describe('AS400', function() {
                    it('GlossarySpinner', function() { 
						console.log('Application_name : AS400, Scenario_name : GlossarySpinner');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\GlossarySpinner";
