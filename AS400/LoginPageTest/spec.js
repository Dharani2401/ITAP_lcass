              ...
              describe('AS400', function() {
                    it('LoginPageTest', function() { 
						console.log('Application_name : AS400, Scenario_name : LoginPageTest');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\LoginPageTest";
