              ...
              describe('AS400', function() {
                    it('RulesReportParaNameDownloadButtonCheck', function() { 
						console.log('Application_name : AS400, Scenario_name : RulesReportParaNameDownloadButtonCheck');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\RulesReportParaNameDownloadButtonCheck";
