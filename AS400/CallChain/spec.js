              ...
              describe('AS400', function() {
                    it('CallChain', function() { 
						console.log('Application_name : AS400, Scenario_name : CallChain');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\CallChain";
...
browser.sleep(1000);element(by.xpath(`/html/body/app-root/app-layout/section/app-callchainapp/div[2]/div/div[2]/select`)).isPresent().then(function (text) {
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-callchainapp/div[3]/div/div[5]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
