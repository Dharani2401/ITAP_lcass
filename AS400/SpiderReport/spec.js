              ...
              describe('AS400', function() {
                    it('SpiderReport', function() { 
						console.log('Application_name : AS400, Scenario_name : SpiderReport');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\SpiderReport";
...
browser.sleep(1000);element(by.xpath(`/html/body/app-root/app-layout/section/app-spiderfilterapp/div[2]/div/div[2]/select`)).isPresent().then(function (text) {
