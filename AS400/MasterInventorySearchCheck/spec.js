              ...
              describe('AS400', function() {
                    it('MasterInventorySearchCheck', function() { 
						console.log('Application_name : AS400, Scenario_name : MasterInventorySearchCheck');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\MasterInventorySearchCheck";
...
console.log('test_step_inputCL');});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\MasterInventorySearchCheck";
                        var fname="page7.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //input`)).sendKeys(`CL`);
...
console.log(assert);
if (assert1 == assert){
console.log('Assertion Passed: Expected', assert1, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr[1]/td[2] is equal to`, assert ,'. :Assertion Passed');
}else{
