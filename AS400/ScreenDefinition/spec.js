              ...
              describe('AS400', function() {
                    it('ScreenDefinition', function() { 
						console.log('Application_name : AS400, Scenario_name : ScreenDefinition');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\ScreenDefinition";
...
browser.sleep(1000);element(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-app/div[4]/div[2]/select`)).isPresent().then(function (text) {
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-app/div[5]/div[1]/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
