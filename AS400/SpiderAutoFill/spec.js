              ...
              describe('AS400', function() {
                    it('SpiderAutoFill', function() { 
						console.log('Application_name : AS400, Scenario_name : SpiderAutoFill');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\SpiderAutoFill";
