              ...
              describe('AS400', function() {
                    it('RulesReportTotalEntriesRecord', function() { 
						console.log('Application_name : AS400, Scenario_name : RulesReportTotalEntriesRecord');
...
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\RulesReportTotalEntriesRecord";
...
browser.wait(until.presenceOf(element(by.xpath(` //select[@id="appln"]//option[@value="Fleet Management"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="appln"]//option[@value="Fleet Management"]`))), delay);
element(by.xpath(` //select[@id="appln"]//option[@value="Fleet Management"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="appln"]//option[@value="Fleet Management"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="appln"]//option[@value="Fleet Management"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="appln"]//option[@value="Fleet Management"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="appln"]//option[@value="Fleet Management"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="appln"]//option[@value="Fleet Management"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\RulesReportTotalEntriesRecord";
                        ...
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="appln"]//option[@value="Fleet Management"]`)).click();

browser.wait(until.presenceOf(element(by.xpath(` //select[@id="pgmName"]//option[@value="IAC608.RPG"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="pgmName"]//option[@value="IAC608.RPG"]`))), delay);
element(by.xpath(` //select[@id="pgmName"]//option[@value="IAC608.RPG"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="pgmName"]//option[@value="IAC608.RPG"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="pgmName"]//option[@value="IAC608.RPG"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="pgmName"]//option[@value="IAC608.RPG"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="pgmName"]//option[@value="IAC608.RPG"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="pgmName"]//option[@value="IAC608.RPG"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\RulesReportTotalEntriesRecord";
                        ...
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="pgmName"]//option[@value="IAC608.RPG"]`)).click();
...
if (assert == `Showing 1 to 10 of 897 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[7]/div/div/div/div[4] is equal toShowing 1 to 10 of 897 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[7]/div/div/div/div[4] But has Showing 1 to 10 of 897 entries. :Assertion Failed`);
browser.quit();
}
});
...
browser.wait(until.presenceOf(element(by.xpath(` //select[@id="pgmName"]//option[@value="IAC001.RPG"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="pgmName"]//option[@value="IAC001.RPG"]`))), delay);
element(by.xpath(` //select[@id="pgmName"]//option[@value="IAC001.RPG"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="pgmName"]//option[@value="IAC001.RPG"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="pgmName"]//option[@value="IAC001.RPG"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="pgmName"]//option[@value="IAC001.RPG"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="pgmName"]//option[@value="IAC001.RPG"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="pgmName"]//option[@value="IAC001.RPG"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="D:\\iTAP\\Recorded_Scenarios\\AS400\\RulesReportTotalEntriesRecord";
                        ...
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="pgmName"]//option[@value="IAC001.RPG"]`)).click();
...
if (assert == `Showing 1 to 10 of 438 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[7]/div/div/div/div[4] is equal toShowing 1 to 10 of 438 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[7]/div/div/div/div[4] But has Showing 1 to 10 of 438 entries. :Assertion Failed`);
browser.quit();
}
});
